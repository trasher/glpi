...
class Inventory
{
   ...
   static function getMenuContent() {
      ...
      $agents = "<i class=\"fa fa-users pointer\" title=\"" . \Agent::getTypeName(\Session::getPluralNumber()) .
         "\"></i><span class=\"sr-only\">" . \Agent::getTypeName(\Session::getPluralNumber()). "</span>";
      $menu['links'][$agents] = \Agent::getSearchURL(false);

      $lockeds = "<i class=\"fa fa-lock pointer\" title=\"" . \Lockedfield::getTypeName(\Session::getPluralNumber()) .
         "\"></i><span class=\"sr-only\">" . \Lockedfield::getTypeName(\Session::getPluralNumber()). "</span>";
      $menu['links'][$lockeds] = \Lockedfield::getSearchURL(false);
   ...
   public function handleItem() {
      ...
      $this->mainasset->setExtraData($this->assets);
      ...
      if (!$this->mainasset->areLinksHandled()) {
         //calll onle once handleLinks. This may be called, as example, from \Glpi\Inventory\Asset\Computer::rulepassed
