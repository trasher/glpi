...
class DatabaseInstance extends CommonDBChild {
   ...
   // From CommonDBChild
   static public $itemtype       = 'Database';
   static public $items_id       = 'databases_id';
    ...
    * @return void|boolean
   **/
   static function showForDatabase(Database $database) {
      ...
      if ($canedit) {
         echo "<div class='center firstbloc'>".
                "<a class='vsubmit' href='".static::getFormURL()."?databases_id=$ID'>";
      ...
      Session::initNavigateListItems(
         self::class,
         sprintf(
            __('%1$s = %2$s'), Database::getTypeName(1),
   ...
   function showForm($ID, $options = []) {
      ...
      $database->getFromDB($this->fields['databases_id']);
      echo "<tr>";
      echo "<td>".Database::getTypeName(1)."</td>";
      echo "<td>";
      echo $database->getLink();
      echo Html::hidden('databases_id', ['value' => $this->fields['databases_id']]);
      echo "</td>";
      echo "</tr>";
