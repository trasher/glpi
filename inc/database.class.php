 ...
 * Database Class
**/
class Database extends CommonDBTM {
   ...
   function defineTabs($options = []) {
      ...
      $this->addDefaultFormTab($ong)
         ...
         ->addStandardTab(Database_Item::class, $ong, $options)
   ...
   function showForm($ID, $options = []) {
      ...
      Location::dropdown(['value'  => $this->fields["locations_id"],
         ...
         'rand' => $rand]);
      echo "</td>";
      echo "<td><label for='dropdown_databasetypes_id$rand'>".DatabaseType::getFieldLabel()."</label></td>";
      echo "<td>";
      DatabaseType::dropdown(['value' => $this->fields["databasetypes_id"], 'rand' => $rand]);
      echo "</td></tr>\n";
      ...
      echo "</td>";
      echo "<td><label for='dropdown_databasecategories_id$rand'>".DatabaseCategory::getTypeName(1)."</label></td>";
      echo "<td>";
      DatabaseCategory::dropdown(['value' => $this->fields["databasecategories_id"], 'rand' => $rand]);
      echo "</td></tr>\n";
      ...
      if ($this->isNewItem($ID)) {
         ...
         echo "</tr>";
         echo "<tr class='tab_bg_1'>";
         echo "<td><label for='instance_port$rand'>"._n('Port', 'Ports', 1)."</label></td>";
         echo "<td>";
         echo Html::input(
            'instance_port', [
               'type' => 'number',
               'id' => 'instance_port'.$rand
            ]
         );

         echo "</td>";
         echo "<td><label for='dropdown_instance_is_onbackup$rand'>".__('Has backup')."</label></td>";
         echo "<td>";
         Dropdown::showYesNo('instance_is_onbackup', 0, -1, ['rand' => $rand]);
         echo "</td></tr>\n";
      }
   ...
   function rawSearchOptions() {
      ...
      $tab[] = [
         'id'                 => '40',
         'table'              => DatabaseCategory::getTable(),
         'field'              => 'name',
      ...
      $tab = array_merge($tab, DatabaseInstance::rawSearchOptionsToAdd());
   ...
   function post_addItem() {
      ...
      if ((!isset($this->input['instance_name']) || empty($this->input['instance_name'])) && isset($this->input['name'])) {
         $this->input['instance_name'] = sprintf(
      ...
      $instance->add([
         'name' => ($this->input['instance_name'] ?? $this->input['name']),
         'port' => ($this->input['instance_port'] ?? 0),
         'size' => ($this->input['instance_size'] ?? 0),
         'is_onbackup' => ($this->input['instance_is_onbackup'] ?? 0),
         'is_active' => ($this->input['instance_is_active'] ?? $this->fields['is_active']),
         'entities_id' => $this->fields['entities_id'],
         'is_recursive' => $this->fields['is_recursive'],
         'databases_id' => $this->fields['id']
      ]);
   ...
   public function getInstances(): array {
      ...
      $iterator = $DB->request([
         ...
         'WHERE' => ['databases_id' => $this->fields['id']]
      ]);
