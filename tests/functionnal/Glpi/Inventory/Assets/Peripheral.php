...
class Peripheral extends AbstractInventoryAsset {
   ...
   protected function assetProvider() :array {
      return [
         ...
         <QUERY>INVENTORY</QUERY>
            ...
            'asset'  => '{"caption": "VFS451 Fingerprint Reader", "manufacturer": "Validity Sensors, Inc.", "name": "VFS451 Fingerprint Reader", "productid": "0007", "serial": "00B0FE47AC85", "vendorid": "138A", "manufacturers_id": "Validity Sensors, Inc."}'
         ]
      ];
   }
   ...
   public function testWrongMainItem() {
      ...
      $asset = new \Glpi\Inventory\Asset\Peripheral($mainasset);
      $this->exception(
         function () use ($asset) {
            $asset->prepare();
         }
      )->message->contains('Peripherals are handled for computers only.');
   }
