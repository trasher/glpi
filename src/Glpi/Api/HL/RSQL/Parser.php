...
final class Parser
{
    ...
    public function parse(array $tokens): Result
    {
        ...
        $sql_where = new QueryExpression($sql_where_string);
        $sql_where->setValues($sql_where_values);
        $sql_having = new QueryExpression($sql_having_string);
        $sql_having->setValues($sql_having_values);
