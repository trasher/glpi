...
REDIPS.drag = (function () {
	...
	handlerOnMouseMove = function (e) {
		...
		if (!moved) {
            ...
            //keep width
            obj.style.width = parseFloat(getStyle(obj, 'width'))
               - parseFloat(getStyle(obj, 'padding-left'))
               - parseFloat(getStyle(obj, 'padding-right'))
               - parseFloat(getStyle(obj, 'border-left-width'))
               - parseFloat(getStyle(obj, 'border-right-width'))
               + 'px';
